      ...
      <v-row>
        ...
        >
          ...
          <n-doughnut  v-if="isDoughnut(field)"
             :item="field" width="100" height="200"></n-doughnut>
          ...
          publishers: Array,
            ...
            isMedia(field: any) {
              ...
              return this.item != null && (field.widget=='text' || field.widget=='time'
                    || field.widget=='number' || field.widget=='date' || field.widget=='file'
                    || field.widget == 'password' || field.widget=='datetime-local') ;
            }, isSelect(field: any) {
              return this.item != null && field.widget == 'select';
